...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cities.index')->with('success', 'Đã thêm thành phố mới.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('cities.trash')->with('success', 'Đã xóa thành phố (tạm thời).');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('cities.trash')->with('success', 'Đã khôi phục thành phố.');
    }
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('cities.trash')->with('success', 'Đã xóa vĩnh viễn thành phố.');
    }
}