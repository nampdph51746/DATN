                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check ms-1">
                                                @php
                                                    ...
                                                    // Kiểm tra thêm điều kiện phim sắp chiếu có suất chiếu
                                                    $hasShowtimes = $movie->showtimes()->exists();
                                                    $hasBookedTickets = $movie->hasBookedTickets();
                                                    
                                                    if ($currentStatus === 'upcoming' && $hasShowtimes) {
                                                        $canBeDeleted = false;
                                                    }
                                                    ...
                                                    if (!$canBeDeleted) {
                                                        ...
                                                        } elseif ($currentStatus === 'upcoming' && $hasShowtimes) {
                                                            $disableReason = 'Phim sắp chiếu đã có suất chiếu, không thể xóa';
                                                        }
                                                    }
                                                @endphp
                                                @if(!$canBeDeleted)
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                @if(!$movie->canBeEdited() || ($currentStatus === 'upcoming' && $hasShowtimes))
                                                    <div class="mt-1">
                                                        ...
                                                        @if($currentStatus === 'upcoming' && $hasShowtimes)
                                                            <span class="badge bg-info-subtle text-info" style="font-size: 0.7rem;">
                                                                <i class="bi bi-calendar-check me-1"></i>Có suất chiếu
                                                            </span>
                                                        @endif
                                                    </div>
                                                @endif
                                                ...
                                                @php
                                                    ...
                                                    if (!$canBeEdited) {
                                                        if ($currentStatus === 'ended') {
                                                            ...
                                                            $disableReason = 'Phim sắp chiếu đã có suất chiếu, không thể chỉnh sửa';
                                                        }
                                                    }
                                                @endphp
                                                @if(!$canBeEdited)
