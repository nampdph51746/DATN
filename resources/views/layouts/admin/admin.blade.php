...
<body>
    ...
    <!-- General Management -->
    <li class="menu-title mt-3">Quản lý chung</li>
    ...
    <!-- Movie Attributes -->
    <li class="nav-item">
        <a class="nav-link menu-arrow" href="#sidebarMovieAttributes" role="button" aria-expanded="false" aria-controls="sidebarMovieAttributes">
            <span class="nav-icon">
                <iconify-icon icon="solar:tag-bold-duotone"></iconify-icon>
            </span>
            <span class="nav-text">Thuộc tính phim</span>
        </a>
        <div class="collapse" id="sidebarMovieAttributes" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.genres.index') }}">Thể loại - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.genres.create') }}">Thể loại - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.age_limits.index') }}">Độ tuổi - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.age_limits.create') }}">Độ tuổi - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.countries.index') }}">Quốc gia - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.countries.create') }}">Quốc gia - Thêm mới</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <!-- Cinemas and Rooms -->
    <li class="nav-item">
        <a class="nav-link menu-arrow" href="#sidebarCinemasRooms" role="button" aria-expanded="false" aria-controls="sidebarCinemasRooms">
            <span class="nav-icon">
                <iconify-icon icon="solar:buildings-2-bold-duotone"></iconify-icon>
            </span>
            <span class="nav-text">Rạp và phòng chiếu</span>
        </a>
        <div class="collapse" id="sidebarCinemasRooms" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.cities.index') }}">Thành phố - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.cities.create') }}">Thành phố - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.cinemas.index') }}">Rạp chiếu - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.cinemas.create') }}">Rạp chiếu - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.rooms.index') }}">Phòng chiếu - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.rooms.create') }}">Phòng chiếu - Thêm mới</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link menu-arrow" href="#sidebarBookingsPayments" role="button" aria-expanded="false" aria-controls="sidebarBookingsPayments">
            <span class="nav-icon">
                <iconify-icon icon="solar:ticket-bold-duotone"></iconify-icon>
            </span>
            <span class="nav-text">Vé và thanh toán</span>
        </a>
        <div class="collapse" id="sidebarBookingsPayments" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.bookings.index') }}">Đặt vé - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.payments.index') }}">Thanh toán - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('tickets.index') }}">Vé - Danh sách</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div class="collapse" id="sidebarSeats" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('seat-type.index') }}">Loại ghế - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('seat-type.create') }}">Loại ghế - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.seats.index') }}">Ghế - Danh sách</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link menu-arrow" href="#sidebarUsers" role="button" aria-expanded="false" aria-controls="sidebarUsers">
            <span class="nav-icon">
                <iconify-icon icon="solar:user-bold-duotone"></iconify-icon>
            </span>
            <span class="nav-text">Người dùng</span>
        </a>
        <div class="collapse" id="sidebarUsers" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('users.index') }}">Hồ sơ</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('roles.index') }}">Quyền hạn</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link menu-arrow" href="#sidebarProducts" role="button" aria-expanded="false" aria-controls="sidebarProducts">
            <span class="nav-icon">
        ...
        <div class="collapse" id="sidebarProducts" data-bs-parent="#navbar-nav">
            <ul class="nav sub-navbar-nav">
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.product-categories.index') }}">Danh mục - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.product-categories.create') }}">Danh mục - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.products.index') }}">Sản phẩm - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.products.create') }}">Sản phẩm - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.product-variants.index') }}">Biến thể - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.product-variants.create') }}">Biến thể - Thêm mới</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.combos.index') }}">Combo - Danh sách</a>
                </li>
                <li class="sub-nav-item">
                    <a class="sub-nav-link" href="{{ route('admin.combos.create') }}">Combo - Thêm mới</a>
                </li>
            </ul>
        </div>
    </li>
