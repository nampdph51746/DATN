                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($variant->stock_quantity == 0)
                                                    <br><small class="text-danger fw-bold">Hết hàng</small>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <span class="badge {{ $variant->is_active && $variant->stock_quantity > 0 ? 'bg-success' : ($variant->stock_quantity == 0 ? 'bg-danger' : 'bg-secondary') }}">
                                                    @if($variant->stock_quantity == 0)
                                                        Hết hàng
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($combos as $idx => $combo)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge {{ $combo->stock_quantity > 0 ? 'bg-success' : 'bg-danger' }}">
