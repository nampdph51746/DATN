                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @switch($status)
                                                            @case('valid')
                                                                <span
                                                                    class="badge bg-success-subtle text-success px-2 py-1 fs-13">Hợp
                                                                    lệ</span>
                                                            @break

                                                            @case('used')
                                                                <span
                                                                    class="badge bg-primary-subtle text-primary px-2 py-1 fs-13">Đã
                                                                    sử dụng</span>
                                                            @break
                                                            ...
                                                            @default
                                                                <span class="badge bg-light text-dark px-2 py-1 fs-13">Không
                                                                    rõ</span>
                                                        @endswitch
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $ticket->updated_at ? $ticket->updated_at->format('d/m/Y H:i') : '-' }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                <td>{{ $ticket->showtime->movie->title ?? '-' }}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $ticket->showtime->start_time ? $ticket->showtime->start_time->format('d/m/Y H:i') : '-' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
