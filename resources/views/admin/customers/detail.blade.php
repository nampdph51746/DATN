            ...
            <div class="col-lg-4">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="mt-4 pt-3">
                            <h4 class="mb-1">{{ $customer->name }}<i class="bx bxs-badge-check text-success align-middle"></i>
                            </h4>
                            <div class="mt-2">
                                <a href="#!" class="link-primary fs-15">@michael_cus_2024</a>
                                <p class="fs-15 mb-1 mt-1"><span class="text-dark fw-semibold">Email : </span>
                                    {{ $customer->email }}</p>
                                <p class="fs-15 mb-0 mt-1"><span class="text-dark fw-semibold">Phone : </span> {{ $customer->phone_number }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark fw-medium px-0">{{ $customer->address }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    <div class="d-flex align-items-center">
                                        <h5 class="text-dark mb-0">All Account <span class="text-muted fw-normal ms-1"><i
                                    ...
                                    <h3 class="fw-semibold mt-2 mb-0">$4,700 <span class="fs-5 text-muted ms-1">+$232</span>
                                    </h3>
