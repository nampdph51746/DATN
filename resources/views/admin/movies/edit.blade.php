                    ...
                    <form action="{{ route('admin.movies.update', $movie->id) }}" method="POST" id="movie-edit-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="mt-2">
                                    <img id="poster-preview"
                                         src="{{ $movie->poster_url ? asset($movie->poster_url) : asset('assets/images/default-poster.png') }}"
                                         alt="Poster phim" style="max-width: 200px;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <select id="movieGenres" name="movieGenres[]" class="form-control" multiple>
                                    @foreach ($genres as $genre)
                                        <option value="{{ $genre->id }}"
                                            {{ (collect(old('movieGenres', $movie->genres->pluck('id')->toArray()))->contains($genre->id)) ? 'selected' : '' }}>
                                            {{ $genre->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('movieGenres') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-lg-12 mb-3">
