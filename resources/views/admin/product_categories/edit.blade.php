            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center gap-2">
                        <iconify-icon icon="solar:pen-new-round" class="align-middle fs-24 text-primary"></iconify-icon>
                        <h4 class="card-title mb-0">Cập nhật danh mục sản phẩm</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Nhập tên danh mục" value="{{ old('name', $category->name) }}">
                                        </div>
                                        @error('name')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea id="description" name="description" class="form-control" placeholder="Nhập mô tả cho danh mục" rows="4">{{ old('description', $category->description) }}</textarea>
                                        </div>
                                        @error('description')
                                            <span class="text-danger d-flex align-items-center mt-1">
                                                <iconify-icon icon="solar:info-circle-broken" class="fs-16 me-1"></iconify-icon>
