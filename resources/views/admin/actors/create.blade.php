...
<div class="container-xxl">
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-4">
            <div class="card">
                <div class="card-body">
                    <img id="imagePreview" src="{{ asset('assets/images/actor-placeholder.png') }}" alt="Actor Image" class="img-fluid rounded bg-light">
                    <div class="mt-3">
                        <h4>Thêm diễn viên mới</h4>
                        <p class="text-muted">Nhập thông tin để thêm một diễn viên mới vào hệ thống.</p>
                    </div>
                </div>
                <div class="card-footer bg-light-subtle">
                    <div class="row g-2">
                        <div class="col-lg-6">
                            <button type="submit" form="actorCreateForm" class="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2">
                                <i class="bx bx-save fs-18"></i> Lưu
                            </button>
                        </div>
                        <div class="col-lg-6">
                            <a href="{{ route('admin.actors.index') }}" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center gap-2">
        ...
        <div class="col-xl-9 col-lg-8">
            <div class="card">
                <div class="card-header" style="background: #ff6633; border-bottom: 1px solid #e55a2b;">
                    <h4 class="card-title" style="color: #333333; font-weight: 600;">Thêm diễn viên mới</h4>
                </div>
                <div class="card-body">
                    <form id="actorCreateForm" action="{{ route('admin.actors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="image" class="form-label">Ảnh diễn viên</label>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="biography" id="biography" class="form-control @error('biography') is-invalid @enderror" rows="5" placeholder="Nhập tiểu sử của diễn viên...">{{ old('biography') }}</textarea>
                                    @error('biography')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('admin.actors.index') }}" class="btn btn-outline-secondary">Hủy</a>
                        </div>
                    </form>
                </div>
            </div>
...
document.getElementById('image').addEventListener('change', function(event) {
    ...
    if (file && file.type.startsWith('image/')) {
        ...
        preview.src = "{{ asset('assets/images/actor-placeholder.png') }}";
        if (file) {
