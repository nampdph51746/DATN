            ...
            <div class="col">
                <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                    <div id="form">
                        ...
                        <br>
                        <fieldset style="max-width: 1200px; margin: 0 auto; text-align: center;">
                            ...
                            <input id="screen-next-btn" type="button" name="next-step" class="next-step"
                                value="Tiếp tục đặt vé" disabled />
                        </fieldset>
                        <fieldset>
                            <div>
                            ...
                            <input type="button" name="next-step" id="proceed-snack-btn" class="next-step"
                                value="Chuyển sang chọn bắp nước" />
