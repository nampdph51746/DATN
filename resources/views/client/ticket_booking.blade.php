                        ...
                        <fieldset>
                            <div style="max-width:1100px;margin:0 auto;padding:20px;">
                                <div style="display:flex;gap:30px;align-items:flex-start;">
                                    ...
                                    <div
                                        style="flex:2.5;background:#fff;border-radius:16px;box-shadow: 0 6px 18px rgba(0,0,0,0.08);">
                                        <!-- Payment Header -->
                                        <div
                                        ...
                                        <div style="padding:30px;">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div style="display:flex;align-items:center;gap:10px;">
                                                        <div
                                                            ...
                                                            1</div>
                                                        <span style="font-weight:700;color:#d32f2f;font-size:1.2em;">GIẢM
                                                            GIÁ</span>
                                                    </div>
                                                    <button type="button"
                                                ...
                                                <div style="margin-top:16px;display:grid;gap:16px;">
                                                    ...
                                                    <div style="display:flex;flex-direction:column;gap:6px;">
                                                        <label style="color:#555;font-size:0.95em;">Điểm thành viên</label>
                                                        <input type="number"
                                                            style="width:100%;border-radius:8px;border:1px solid #ddd;padding:12px 16px;font-size:1em;"
                                            ...
                                            <div
                                                ...
                                                <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;">
                                                    <div
                                                        style="background:#d32f2f;color:white;width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:bold;">
                                                        2</div>
                                                    <span style="font-weight:700;color:#d32f2f;font-size:1.2em;">HÌNH THỨC
                                                        THANH TOÁN</span>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <label for="agree" style="color:#555;line-height:1.5;">
                                                        Tôi đồng ý với <a href="#"
                                                            style="color:#d32f2f;text-decoration:underline;">điều khoản sử
                                                            dụng</a> và mua vé cho người có độ tuổi phù hợp
                                                    </label>
                                                </div>

                                                <button type="submit"
                                                    style="width:100%;padding:16px;font-weight:700;font-size:1.1em;background:linear-gradient(135deg, #d32f2f, #b71c1c);color:white;border:none;border-radius:10px;box-shadow: 0 4px 12px rgba(211,47,47,0.3);transition:all 0.3s;cursor:pointer;">
                                                    THANH TOÁN 120.000 ₫
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div style="flex:1.5;position:sticky;top:20px;">
                                        <!-- Order Summary -->
                                        <div
                                            style="background:#fff;border-radius:16px;box-shadow: 0 6px 18px rgba(0,0,0,0.08);margin-bottom:20px;">
                                            <div
                                            ...
                                            <div style="padding:24px;">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <div style="font-weight:700;margin-bottom:6px;font-size:1.1em;">Tên
                                                            phim</div>
                                                        <div style="font-size:0.9em;color:#666;margin-bottom:4px;">2D Phụ
                                                            đề</div>
                                                ...
                                                <div
                                                    style="margin-bottom:20px;padding-bottom:20px;border-bottom:1px solid #eee;">
                                                    <div style="font-weight:600;margin-bottom:12px;color:#333;">Khuyến mãi
                                                    </div>
                                                    <div style="display:flex;justify-content:space-between;">
