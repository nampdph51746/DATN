  ...
  <div class="row gx-5 align-items-start">
    ...
    <div class="col-lg-8">
      <div class="card border-0 shadow-sm rounded p-4">
        ...
        <!-- Rooms Section - NO Bootstrap Collapse Classes -->
        <div class="mt-4">
          <div class="card">
            ...
            <!-- Using normal div with manual style display -->
...
function toggleRoomsSection() {
    ...
    if (!content || !chevron) {
        console.error('❌ Elements not found:', { content, chevron });
        return;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎬 Page loaded - Accordion ready');
});
</script>
@endsection
@endsection
