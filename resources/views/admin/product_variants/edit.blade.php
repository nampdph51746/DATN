...
<div class="container-xxl">
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{ $productVariant->image_url ? asset('storage/' . $productVariant->image_url) : asset('assets/images/default.png') }}" alt="" class="img-fluid rounded bg-light" id="previewImage">
                    <div class="mt-3">
                        <h4>{{ old('sku', $productVariant->sku) }}</h4>
                    </div>
                </div>
                <div class="card-footer bg-light-subtle">
                    <div class="row g-2">
                        <div class="col-lg-6">
                            <button type="button" class="btn btn-outline-secondary w-100" onclick="submitForm()">Cập nhật biến thể</button>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="price" name="price" class="form-control" value="{{ old('price', $productVariant->price) }}" placeholder="Giá biến thể (VNĐ)" step="0.01">
                                    @error('price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="stock" name="stock_quantity" class="form-control" value="{{ old('stock_quantity', $productVariant->stock_quantity) }}" placeholder="Số lượng tồn kho">
