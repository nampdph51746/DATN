        ...
        <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    ...
                    @if(session('city_created'))
                        <small class="d-block mt-1 text-success-emphasis">
                            <i class="fas fa-info-circle me-1"></i>
                            Thành phố mới đã được thêm vào đầu danh sách bên dưới.
                        </small>
                    @endif
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <a href="{{ route('admin.cities.trash') }}" class="btn btn-outline-danger btn-lg rounded-pill">
                        <i class="fas fa-trash-alt me-2"></i> Thùng rác
                    </a>
                    <a href="{{ route('admin.cities.create') }}" class="btn btn-primary btn-lg rounded-pill">
                        <i class="fas fa-plus-circle me-2"></i> Thêm thành phố
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0 fw-bold" style="color: var(--primary-teal);">{{ $cities->total() }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0 fw-bold" style="color: var(--primary-orange);">{{ $cities->total() }}</h3>
                        </div>
                    </div>
                </div>
                <div class="progress rounded-0" style="height: 4px;">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0 fw-bold" style="color: var(--accent-yellow);">{{ $cities->where('created_at', '>=', now()->startOfWeek())->count() }}</h3>
                        </div>
                    </div>
                </div>
                <div class="progress rounded-0" style="height: 4px;">
        ...
        <div class="col-12">
            <div class="card border-0">
                <div class="card-header">
                    ...
                    <!-- Bulk Actions -->
                    {{-- <form id="delete-selected-form" action="{{ route('admin.cities.bulkDelete') }}" method="POST" style="display: none;" class="mt-3">
                        @csrf
                        @method('DELETE')
                        ...
                        <div class="alert alert-warning border-0 rounded-4 d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <strong>Xóa nhiều thành phố đã chọn</strong>
                                <p class="mb-0 small">Bạn có chắc muốn xóa các thành phố đã chọn?</p>
                            </div>
                            <button type="submit" class="btn btn-danger rounded-pill" onclick="return confirm('Bạn có chắc muốn xóa các thành phố đã chọn?')">
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="border-0 fw-bold text-dark">
                                        <i class="fas fa-city me-1" style="color: var(--primary-teal);"></i> Tên thành phố
                                    </th>
                                    <th class="border-0 fw-bold text-dark">
                                        <i class="fas fa-globe-asia me-1" style="color: var(--accent-yellow);"></i> Quốc gia
                                    </th>
                                    <th class="border-0 fw-bold text-dark">
                                    ...
                                    <tr class="border-bottom border-light">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="mb-1 fw-bold" style="color: var(--primary-teal);">{{ $city->name }}</h6>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-globe-asia text-warning me-2" style="color: var(--accent-yellow);"></i>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="fw-bold">{{ $city->created_at->format('d/m/Y') }}</span>
                                                    <small class="text-muted d-block">{{ $city->created_at->format('H:i') }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="fw-bold">{{ $city->updated_at->format('d/m/Y') }}</span>
                                                    <small class="text-muted d-block">{{ $city->updated_at->diffForHumans() }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center pe-4">
                                            <div class="d-flex gap-1 justify-content-center">
                                                @if(Route::has('admin.cities.show'))
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                <i class="fas fa-city text-muted fs-1 mb-3"></i>
