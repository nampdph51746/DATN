          ...
          <div class="col-xl-12">
               <div class="card">
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                         ...
                         <form action="{{ route('cities.trash') }}" method="GET" class="d-flex align-items-center">
                         ...
                         <a href="{{ route('cities.index') }}" class="btn btn-sm btn-outline-dark">
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             <div class="d-flex gap-2">
                                                  ...
                                                  {{-- Xóa vĩnh viễn --}}
                                                  <form action="{{ route('cities.forceDelete', $city->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa vĩnh viễn thành phố này?')">
                                                       @csrf
                                                       @method('DELETE')
