    ...
    public function show($id)
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cinemas.index')->with('success', 'Đã thêm rạp chiếu phim mới thành công.');
    }
    ...
    public function update(Request $request, Cinema $cinema)
    {
        ...
        return redirect()->route('cinemas.index')->with('success', 'Đã cập nhật rạp chiếu phim thành công.');
    }
    ...
    public function destroy(Cinema $cinema)
    {
        ...
        return redirect()->route('cinemas.index')->with('success', 'Đã chuyển rạp vào thùng rác.');
    }
    ...
    public function trash(Request $request)
{
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('cinemas.trash')->with('success', 'Đã khôi phục rạp.');
    }
