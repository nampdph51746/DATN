          ...
          <div class="col-xl-12">
               <div class="card">
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                        ...
                        <form action="{{ route('countries.trash') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <form action="{{ route('countries.forceDelete', $country->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa vĩnh viễn quốc gia này?')">
                                                @csrf
                                                @method('DELETE')
