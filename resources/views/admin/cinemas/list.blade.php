        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <form action="{{ route('cinemas.index') }}" method="GET" class="d-flex align-items-center">
                                             ...
                                             <tr>
                                                  ...
                                                  <td>
                                                       <div class="d-flex gap-2">
                                                            ...
                                                            <a href="{{ route('cinemas.edit', $cinema->id) }}" class="btn btn-soft-primary btn-sm">
                                                                 <iconify-icon icon="solar:pen-2-broken" class="fs-18"></iconify-icon>
                                                            </a>
                                                            <form action="{{ route('cinemas.destroy', $cinema->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa rạp chiếu này?')">
                                                                 @csrf
                                                                 @method('DELETE')
