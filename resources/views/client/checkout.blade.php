            ...
            @if ($bookingData)
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        // Log để kiểm tra dữ liệu form trước khi gửi
                        console.log('Checkout Form Data:', {
                            promotion_id: document.querySelector('input[name="promotion_id"]').value,
                            final_amount: document.querySelector('input[name="final_amount"]').value,
