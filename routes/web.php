...
// Route::middleware('auth')->prefix('booking-history')->name('client.booking.')->group(function () {
//     Route::get('/', [BookingHistoryController::class, 'index'])->name('history');
//     Route::get('/{id}', [BookingHistoryController::class, 'show'])->name('show');
// });
