...
if (conversionsEl) {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    name: {
                        fontSize: '14px',
                        color: "#6c757d", // thay "undefined" bằng màu mặc định
                        offsetY: 100
                    },
                    value: {
                        offsetY: 55,
    ...
    const conversionsChart = new ApexCharts(conversionsEl, conversionsOptions);
...
if (performanceEl) {
    ...
    const performanceChart = new ApexCharts(performanceEl, performanceOptions);
