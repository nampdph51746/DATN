        ...
        <div class="card-body px-4 py-4 position-relative">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                <div>
                    ...
                    <p class="mb-1"><strong>Số tiền:</strong> {{ $payment->amount ? number_format($payment->amount, 0, ',', '.') . ' đ' : '-' }}</p>
