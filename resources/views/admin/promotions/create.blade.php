                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="promotion-name" name="name" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="promotion-code" name="code" class="form-control"
                                            placeholder="Nhập mã khuyến mãi" value="{{ old('code') }}">
                                        @error('code')
                                            <span class="text-danger fs-13">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="promotion-status" name="status" data-choices
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="promotion-discount-type" name="discount_type"
                                            data-choices data-choices-groups data-placeholder="Chọn loại giảm giá">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" id="promotion-discount-value"
                                            name="discount_value" class="form-control" placeholder="Nhập giá trị giảm giá"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="promotion-max-discount-amount" class="form-label">Giá trị giảm tối
                                            đa</label>
                                        <input type="number" step="0.01" id="promotion-max-discount-amount"
                                            name="max_discount_amount" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="promotion-min-booking-value" class="form-label">Giá trị đơn hàng tối
                                            thiểu</label>
                                        <input type="number" step="0.01" id="promotion-min-booking-value"
                                            name="min_booking_value" class="form-control"
                                            placeholder="Nhập giá trị đơn hàng tối thiểu"
                                            value="{{ old('min_booking_value') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" id="promotion-start-date" name="start_date"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" id="promotion-end-date" name="end_date"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="promotion-quantity" name="quantity"
                                            class="form-control" placeholder="Nhập số lượng mã"
                                            value="{{ old('quantity') }}">
                                        @error('quantity')
                                            <span class="text-danger fs-13">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="promotion-usage-limit" class="form-label">Giới hạn sử dụng mỗi người
                                            dùng</label>
                                        <input type="number" id="promotion-usage-limit" name="usage_limit_per_user"
                                            class="form-control" placeholder="Nhập giới hạn sử dụng"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="promotion-applies-to" name="applies_to"
                                            data-choices data-choices-groups data-placeholder="Chọn đối tượng áp dụng">
                                            <option value="">Chọn đối tượng áp dụng</option>
                                            <option value="movies" {{ old('applies_to') == 'movies' ? 'selected' : '' }}>
                                                Movies</option>
                                            <option value="tickets"
                                                {{ old('applies_to') == 'tickets' ? 'selected' : '' }}>Tickets</option>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle" id="promotion-description" name="description" rows="7"
