            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    @can('create product category')
                        <a href="{{ route('admin.product-categories.create') }}" class="btn btn-primary btn-lg rounded-pill">
                            <i class="fas fa-plus-circle me-2"></i> Thêm danh mục mới
                        </a>
                    @endcan
                    @can('delete product category')
                        <a href="{{ route('admin.product-categories.trash') }}" class="btn btn-success btn-lg rounded-pill">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0 text-muted fw-semibold">Tổng danh mục</h6>
                            <h3 class="mb-0 fw-bold" style="color: var(--primary-teal);">{{ $categories->total() }}</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-4">
                            <div class="d-flex gap-2 justify-content-end flex-wrap">
                                <form class="d-flex align-items-center gap-2" method="GET" action="{{ route('admin.product-categories.index') }}">
                        ...
                        <table class="table table-hover mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="border-0 fw-bold text-dark">
                                        <i class="fas fa-box-open me-1" style="color: var(--primary-orange);"></i> Tên danh mục
                                    </th>
                                    <th class="border-0 fw-bold text-dark">
                            ...
                            <tbody>
                                @forelse ($categories as $category)
                                    <tr class="border-bottom border-light">
                                        ...
                                        <td>
                                            <span class="fw-medium"><i class="fas fa-box-open me-2 text-orange"></i>{{ $category->name }}</span>
                                        </td>
                                        <td>{{ Str::limit($category->description, 50) }}</td>
                                        <td>
                                            <span class="text-muted"><i class="fas fa-calendar-alt me-2"></i>{{ $category->created_at->format('d/m/Y H:i') }}</span>
                                        </td>
                    ...
                    <div class="card-footer bg-white border-top py-4 rounded-bottom-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                Hiển thị {{ $categories->firstItem() }}-{{ $categories->lastItem() }} trong tổng {{ $categories->total() }} danh mục
                            </div>
                            <div>
