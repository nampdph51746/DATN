            ...
            <div class="col-xl-10 col-lg-9">
                <div class="card">
                    <div class="card-header" style="background: #ff6633; border-bottom: 1px solid #e55a2b;">
                        <h4 class="card-title" style="color: #333333; font-weight: 600;">Sửa rạp chiếu phim</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.cinemas.update', $cinema->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                           ...
                                           value="{{ old('name', $cinema->name) }}" placeholder="Nhập tên rạp">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" id="address" rows="2"
                                          ...
                                          placeholder="Nhập địa chỉ">{{ old('address', $cinema->address) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" name="email" id="email"
                                           ...
                                           value="{{ old('email', $cinema->email) }}" placeholder="VD: contact@cinema.vn">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="hotline" id="hotline"
                                           ...
                                           value="{{ old('hotline', $cinema->hotline) }}" placeholder="VD: 19001000">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="map_url" id="map_url"
                                       ...
                                       value="{{ old('map_url', $cinema->map_url) }}" placeholder="Google Maps URL">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('assets/' . $cinema->image_url) }}" alt="{{ $cinema->name }}" style="max-width: 200px; height: auto;">
                            </div>
                            @endif

                            {{-- URL ảnh rạp mới --}}
                            <div class="mb-3">
                                <label for="image" class="form-label">Thay đổi ảnh rạp (nếu có)</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="opening_hours" id="opening_hours"
                                           ...
                                           value="{{ old('opening_hours', $cinema->opening_hours) }}" placeholder="VD: 08:00 - 23:00">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          ...
                                          placeholder="Mô tả rạp chiếu">{{ old('description', $cinema->description) }}</textarea>
