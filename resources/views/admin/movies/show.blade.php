                            ...
                            <div class="poster-frame position-relative">
                                ...
                                <div class="position-absolute top-0 end-0 m-3">
                                    ...
                                    if ($movie->end_date && $movie->end_date < now()) {
                                        ...
                                        $statusConfig=[ 'showing'=> ['class' => 'bg-success', 'icon' => 'bx-play-circle', 'label' => 'Đang chiếu'],
                                ...
                                <div class="row g-4 align-items-end">
                                    <div class="col-md-4">
                                        ...
                                        <select name="room_ids[]" class="form-control rounded-3" multiple required id="roomSelect"
                                            @if($movie->status === \App\Enums\MovieStatus::Ended) disabled @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="d-flex gap-2">
                                            @if($movie->status === \App\Enums\MovieStatus::Ended)
                                            <span class="text-muted">Phim đã kết thúc</span>
                                            @else
                                            <button type="button"
...
<script>
    ...
    function getShowtimeSlots(date, durationMinutes, maxShowtimes = 'auto') {
        console.log('getShowtimeSlots được gọi với:', {
            date,
            durationMinutes,
            maxShowtimes
        });
        ...
        while (currentTime.getTime() + durationMinutes * 60 * 1000 <= endOfDay.getTime()) {
            ...
            if (conflictInterval) {
                ...
                const startTimeStr = proposedStart.toLocaleTimeString('vi-VN', {
                    hour: '2-digit',
                    minute: '2-digit'
                });
                const endTimeStr = proposedEnd.toLocaleTimeString('vi-VN', {
                    hour: '2-digit',
                    minute: '2-digit'
                });
