...
Route::get('/movies/{id}', [ClientController::class, 'show'])->name('movies.show');
Route::get('/movies/{id}/ticket-booking', [ClientController::class, 'ticketBooking'])->name('client.movies.ticketBooking');
