        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <form action="{{ route('cinemas.trash') }}" method="GET" class="d-flex align-items-center">
                        ...
                        <a href="{{ route('cinemas.index') }}" class="btn btn-sm btn-outline-dark">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('cinemas.show', $cinema->id) }}" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                            <form action="{{ route('cinemas.restore', $cinema->id) }}" method="POST" onsubmit="return confirm('Khôi phục rạp này?')">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('cinemas.forceDelete', $cinema->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa vĩnh viễn rạp chiếu này?')">
    @csrf
    @method('DELETE')
