                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div class="text-white">
                                <h2 class="fw-bold mb-2">Thùng rác - Thành phố</h2>
                                <p class="mb-0 opacity-90 fs-5">Danh sách các thành phố đã bị xóa</p>
                            </div>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0 fw-bold text-danger">{{ $cities->total() }}</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-8">
                            <h5 class="card-title mb-0 fw-bold text-dark">
                                ...
                                Danh sách thành phố đã xóa
                            </h5>
                        </div>
                        <div class="col-lg-6 col-md-4">
                            <div class="d-flex gap-2 justify-content-end">
                                <form action="{{ route('admin.cities.trash') }}" method="GET" class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.cities.index') }}" class="btn btn-outline-secondary rounded-pill">
                                    ...
                                    <tr class="border-bottom border-light">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="fw-semibold text-muted">{{ $city->country->name ?? 'Không xác định' }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-muted">
                                                <i class="bi bi-clock-history me-1 text-danger"></i>
                                                {{ $city->deleted_at->format('d/m/Y') }}
                                                <br>
                                                <small class="text-muted">{{ $city->deleted_at->format('H:i') }}</small>
                                            </div>
                                        </td>
                                        <td class="text-center pe-4">
                                            <div class="dropdown position-static">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4">
                                                    <li>
                                                        <form action="{{ route('admin.cities.restore', $city->id) }}" 
                                                              method="POST" 
                                                            ...
                                                            <button type="submit" 
                                                                    ...
                                                                    onclick="return confirm('Bạn có chắc chắn muốn khôi phục thành phố này?')">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('admin.cities.forceDelete', $city->id) }}" 
                                                              method="POST" 
                                                              class="d-inline w-100"
                                                              onsubmit="return confirm('Bạn có chắc chắn muốn xóa vĩnh viễn thành phố này? Hành động này không thể hoàn tác!')">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" 
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted small mb-0">Không có thành phố nào bị xóa</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                    ...
                    <div class="card-footer bg-white border-top py-4 rounded-bottom-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                Hiển thị {{ $cities->firstItem() }}-{{ $cities->lastItem() }} trong tổng {{ $cities->total() }} thành phố đã xóa
                            </div>
                            <div>
