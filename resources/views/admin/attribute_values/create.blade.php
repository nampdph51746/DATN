                            ...
                            <form method="POST" action="{{ route('admin.attribute-values.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if (isset($selectedAttributeId) && $selectedAttributeId)
                                            @php
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $selectedAttribute ? $selectedAttribute->name : '' }}" readonly>
                                        @else
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="value" id="value"
                                            ...
                                            placeholder="Nhập giá trị thuộc tính" value="{{ old('value') }}">
                                        @error('value')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
