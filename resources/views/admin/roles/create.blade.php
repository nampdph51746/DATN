                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div class="text-white">
                                <h2 class="fw-bold mb-2">Thêm vai trò mới</h2>
                                <p class="mb-0 opacity-90 fs-5">Tạo thông tin vai trò mới trong hệ thống</p>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label fw-bold" for="check-all-permissions">
