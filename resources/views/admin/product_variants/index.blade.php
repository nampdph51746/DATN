                            ...
                            <table class="table align-middle mb-0 table-hover table-centered">
                                <thead class="bg-light-subtle">
                                    <tr>
                                        ...
                                        <th>
                                            <iconify-icon icon="material-symbols:image"
                                                class="align-middle fs-16 me-1"></iconify-icon>
                                            Ảnh sản phẩm
                                        </th>
                                        <th>
                                        ...
                                        <th>
                                            <iconify-icon icon="solar:barcode-broken"
                                                class="align-middle fs-16 me-1"></iconify-icon>
                                            SKU
                                        </th>
                                        <th>
                                        ...
                                        <th>
                                            <iconify-icon icon="solar:cart-broken"
                                                class="align-middle fs-16 me-1"></iconify-icon>
                                            Tồn kho
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    @forelse ($productVariants as $variant)
                                        <tr>
                                            <td>{{ $loop->iteration + ($productVariants->currentPage() - 1) * $productVariants->perPage() }}
                                            </td>
                                            <td>
