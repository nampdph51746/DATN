...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('countries.index')->with('success', 'Đã thêm quốc gia mới.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('countries.index')->with('success', 'Cập nhật thành công.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('countries.index')->with('success', 'Đã xóa quốc gia.');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('countries.trash')->with('success', 'Quốc gia đã được khôi phục.');
    }
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('countries.trash')->with('success', 'Đã xóa quốc gia vĩnh viễn.');
    }
}