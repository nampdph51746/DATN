            ...
            <div class="row h-100">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="phone_number" name="phone_number" class="form-control"
                                            placeholder="Nhập họ tên của bạn" value="{{ old('phone_number') }}"
                                            >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="date_of_birth" name="date_of_birth" class="form-control"
                                            ...
                                            >
                                        @error('date_of_birth') <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-1 text-center d-grid">
                                        <button class="btn btn-soft-primary" type="submit">Tạo tài khoản</button>
                                    </div>
                                </form>

                                <p class="mt-3 fw-semibold no-span">Hoặc đăng ký với</p>
                                <div class="d-grid gap-2">
                                    <a href="#" class="btn btn-soft-dark"><i class="bx bxl-google fs-20 me-1"></i>
                                        Google</a>
                                    <a href="#" class="btn btn-soft-primary"><i class="bx bxl-facebook fs-20 me-1"></i>
                                        Facebook</a>
                                </div>
                ...
                <div class="col-xxl-5 d-none d-xxl-flex">
                    <div class="card h-100 mb-0 overflow-hidden">
                        <img src="{{ asset('assets/images/small/img-12.jpg') }}" alt="Ảnh nền" class="w-100 h-100">
                    </div>
                </div>
            </div>
        </div>
