            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Customer Rank</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="{{ route('customers-rank.update', $customerRank->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="customer_rank-discount_percentage" name="discount_percentage" class="form-control"
                                            value="{{ old('discount_percentage', $customerRank->discount_percentage) }}" step="0.01" min="0" max="100">
                                    </div>

                                    <div class="mb-3">
                                        <label for="customer_rank-description" class="form-label">Customer Rank Description</label>
                                        <textarea id="customer_rank-description" name="description" class="form-control" rows="5" style="resize: none;">{{ old('description', $customerRank->description) }}</textarea>
                                    </div>

                                    <button type="submit" class="btn btn-primary">Update Customer Rank</button>
                                </form>
                            </div>
                        </div>
                    </div>
