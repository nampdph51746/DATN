        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden modern-card">
                ...
                <div class="card-body text-center p-4">
                    <!-- Combo Image -->
                    <div class="combo-image-container mb-4">
                        @if ($combo->comboProductVariant && $combo->comboProductVariant->image_url)
                            <img src="{{ asset('storage/' . $combo->comboProductVariant->image_url) }}" 
                                 alt="{{ $combo->name }}" 
                                 class="combo-image rounded-4 shadow-sm">
                        @else
                            <div class="no-image-placeholder">
                                <i class="fas fa-boxes"></i>
                                <p class="mt-3 text-muted">Không có ảnh combo</p>
                            </div>
                        @endif
                    </div>
                    
                    <!-- Combo Basic Info -->
                    <div class="combo-basic-info">
                        <div class="combo-id-badge mb-3">
                        ...
                        <h4 class="combo-name mb-3 fw-bold text-dark">{{ $combo->name }}</h4>
                        
                        <div class="combo-meta d-flex justify-content-center gap-3 mb-4">
                            <div class="meta-item">
                ...
                <div class="card-footer bg-light border-0 py-4">
                    <div class="d-grid gap-2">
                        ...
                        @if($combo->comboProductVariant && $combo->comboProductVariant->product)
                            <a href="{{ route('admin.products.show', $combo->comboProductVariant->product->id) }}" 
        ...
        <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="info-value">
                                        {{ $combo->comboProductVariant && $combo->comboProductVariant->product ? $combo->comboProductVariant->product->name : 'Không xác định' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    <h6 class="info-label">Biến thể đại diện</h6>
                                    <p class="info-value">
                                        {{ $combo->comboProductVariant ? $combo->comboProductVariant->sku : 'Không có' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="info-value">
                                        {{ $combo->comboProductVariant && $combo->comboProductVariant->product && $combo->comboProductVariant->product->category ? $combo->comboProductVariant->product->category->name : 'Không xác định' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="info-value">
                                        @if($combo->comboProductVariant && $combo->comboProductVariant->product)
                                            @switch($combo->comboProductVariant->product->product_type)
                                                @case('food')
                                                ...
                                                @break
                                                @default
                                                    {{ $combo->comboProductVariant->product->product_type }}
                                            @endswitch
                                        @else
                                            Không xác định
                                        @endif
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden modern-card mb-4">
                <div class="card-header bg-gradient-success text-white py-4">
                    <h5 class="mb-0 fw-bold">
                        <i class="fas fa-list me-2"></i>
                        Các mục trong combo ({{ $combo->comboPackageItems->count() }} items)
                    </h5>
                </div>
                <div class="card-body p-4">
                    @if($combo->comboPackageItems->count() > 0)
                            ...
                            <table class="table table-hover modern-table mb-0">
                                <thead class="table-header-modern">
                                    <tr>
                                        ...
                                        <th class="border-0 px-3 py-3">
                                            <i class="fas fa-box me-1 text-success"></i>Sản phẩm
                                        </th>
                                        <th class="border-0 px-3 py-3">
                                            <i class="fas fa-cogs me-1 text-info"></i>Biến thể
                                        </th>
                                        <th class="border-0 px-3 py-3">
                                            <i class="fas fa-sort-numeric-up me-1 text-warning"></i>Số lượng
                                        </th>
                                        <th class="border-0 px-3 py-3">
                                            <i class="fas fa-calendar me-1 text-secondary"></i>Ngày thêm
                                        </th>
                                ...
                                <tbody>
                                    @foreach($combo->comboPackageItems as $idx => $item)
                                        <tr class="table-row">
                                            <td class="px-3 py-3">
                                            ...
                                            <td class="px-3 py-3">
                                                <div class="d-flex align-items-center">
                                                    @if($item->itemProductVariant && $item->itemProductVariant->image_url)
                                                        <img src="{{ asset('storage/' . $item->itemProductVariant->image_url) }}" 
                                                             alt="Item" 
                                                             class="rounded me-3" 
                                                    ...
                                                    <div>
                                                        <h6 class="mb-1 fw-bold text-dark">
                                                            {{ $item->itemProductVariant && $item->itemProductVariant->product ? $item->itemProductVariant->product->name : 'Không xác định' }}
                                                        </h6>
                                                        <small class="text-muted">
                                                            {{ $item->itemProductVariant && $item->itemProductVariant->product ? $item->itemProductVariant->product->category->name ?? 'Không có danh mục' : '' }}
                                                        </small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-3 py-3">
                                                <span class="badge bg-info-subtle text-info px-3 py-2 rounded-pill">
                                                    {{ $item->itemProductVariant ? $item->itemProductVariant->sku : 'Không có' }}
                                                </span>
                                            </td>
                                            <td class="px-3 py-3">
                                            ...
                                            <td class="px-3 py-3 text-center">
                                                @if($item->itemProductVariant)
                                                    <a href="{{ route('admin.product-variants.show', $item->itemProductVariant->id) }}" 
                                                       class="btn btn-sm rounded-3 view-btn"
                                                       title="Xem chi tiết biến thể" data-bs-toggle="tooltip">
                    ...
                    @else
                        <div class="empty-state text-center py-4">
                            ...
                            <h6 class="text-muted">Chưa có mục nào</h6>
                            <p class="text-muted mb-3">Combo này chưa có mục nào được thêm vào</p>
                            <a href="{{ route('admin.combos.edit', $combo->id) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="info-value">
                                        {{ $combo->created_at ? $combo->created_at->format('d/m/Y H:i') : 'Không xác định' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="info-value">
                                        {{ $combo->updated_at ? $combo->updated_at->format('d/m/Y H:i') : 'Không xác định' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="summary-box">
                                ...
                                <div class="summary-content">
                                    <p class="mb-0 text-muted">
                                        ...
                                        @if($combo->comboProductVariant && $combo->comboProductVariant->product)
                                            thuộc sản phẩm <strong>{{ $combo->comboProductVariant->product->name }}</strong>
                                        @endif
                                        với giá <strong>{{ number_format($combo->price, 0, ',', '.') }}₫</strong>. 
                                        Hiện có <strong>{{ $combo->comboPackageItems->count() }}</strong> mục trong combo 
                                        và tồn kho là <strong>{{ $combo->stock_quantity }}</strong> đơn vị.
                                    </p>
                                </div>
                            </div>
                        </div>
